        ...
        <header className='w-full'>
            <div className="flex justify-around items-start xs:items-center w-full h-[150px] xs:h-[100px] gap-2 py-8 xs:py-2 bg-gray-100 relative z-50 border-b-2 border-gray-300">
                ...
                <div className="flex justify-between items-center border-2 border-gray-400 gap-2 bg-white xs:relative absolute top-20 xs:top-0 mx-4 ">
                    <MagnifyingGlassIcon className="w-[40px] sm:w-[50px] h-[40px] sm:h-[50px] text-gray-500 flex justify-center items-center text-primary" />
                    <input type="text"
                ...
                <div className="flex gap-4 items-center justify-center px-2">
                    <div className='relative'>
                        <span className="absolute -top-5 -right-2.5 text-primary p-[3px] font-bold">05</span>
                        <HeartIcon className="w-[30px] sm:w-[40px] h-[30px] sm:h-[40px] flex justify-center items-center text-secondary" />
                    </div>
                    <div className='relative'>
            ...
            <div className="hidden md:flex justify-around items-center w-full absolute top-[150px] xs:top-[100px] z-40">
                <ul className='flex gap-4 text-gray-700 bg-gray-100 py-2 px-4 rounded-b-3xl shadow-md'>
                    ...
                    <li className='font-bold pointer hover:text-hoverSecondary cursor-pointer '>Spray</li>
                    <div className='relative group '>
                        ...
                        {isOpen && (
                            <ul className='hidden group-hover:flex flex-col justify-center items-start gap-2 absolute bg-gray-100 w-[200px] -left-15 rounded-b-xl py-4 px-6 shadow-lg z-50'>
                                <li className='font-bold pointer hover:text-hoverSecondary cursor-pointer '>Oil perfumes </li>
                                <li className='font-bold pointer hover:text-hoverSecondary cursor-pointer '>Luxury perfumes </li>
                                <li className='font-bold pointer hover:text-hoverSecondary cursor-pointer '>Designer's perfumes</li>
                                <li className='font-bold pointer hover:text-hoverSecondary cursor-pointer '>Women's perfumes</li>
                                <li className='font-bold pointer hover:text-hoverSecondary cursor-pointer '>Men's perfumes</li>
                                <li className='font-bold pointer hover:text-hoverSecondary cursor-pointer '>Unisex Perfume</li>
                            </ul>
                        )}
                    </div>
